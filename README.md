# 📘 Inflearn React Study

## 🤝 스터디 소개

인프런 이정환 강사님의 한 입 크기로 잘라먹는 리액트 강의 기반으로 진행됩니다.
리액트의 개념을 공부, 이해하고 정리하여 함께 리뷰를 진행합니다.

## 🚀 스터디 진행방식

- 매주 목요일 오후 11시 59분까지 스터디 레포지토리에 학습한 내용을 제출한다.
...
- `Feat: {주제} 실습` (ex. `deat : 인터페이스 실습 코드 추가`)
